...
class Album extends Component {
    ...
    render() {
        return (
            <section className="album text-white">
                <section id="ablum-info">
                    <img id="album-cover-art" src={this.state.album.albumCover} alt={this.state.album.title} className="img-thumbnail" style={{width: 350, height: 350}}/>
